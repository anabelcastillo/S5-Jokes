...
const weatherTemp: HTMLElement | null = document.getElementById("weather-information"); // Div donde se mostrará la temperatura
const weatherIcon: HTMLElement | null = document.getElementById("icon"); // Div donde se mostrará el icono de la temperatura
const showBlob: HTMLElement | null = document.getElementById("blob");
